          ...
          content: [
            {
              ...
              text: [
                ...
                "La consulta puede incluir hechos inferidos desde una imagen bajo el título 'Contexto visual aportado por imagen'. Tratá esos hechos como observaciones visuales, no como reglas.",
                "Diferenciá hechos declarados por el usuario de hechos inferidos visualmente cuando eso ayude a detectar contradicciones.",
                ...
                "Si texto e imagen se contradicen sobre un dato que cambia la decisión, pedí aclaración breve.",
  ...
  return JSON.stringify(
    {
      ...
      guidance: [
        ...
        "Ejemplo visual: 'objeto circular metálico fijo en el suelo' puede emparentarse con tapa, boca de riego, drenaje, aspersor fijo u obstrucción inamovible si el contexto lo sugiere.",
        "Ejemplo visual: 'estaca roja o amarilla visible' puede emparentarse con área de penalización, pero solo si la imagen o el texto la muestran con claridad.",
        "Ejemplo visual: 'arena alrededor de la bola' puede emparentarse con bunker solo si la imagen lo muestra con claridad.",
